...
(function () {
  ...
  var style = '<style>\
    ...
    .card-quality-badges { position: absolute; top: 0.3em; left: 0.3em; display: flex; flex-direction: row; gap: 0.2em; pointer-events: none; z-index: 5; }\
    .card-quality-badge { height: 0.9em; opacity: 0; transform: translateY(0); animation: qb_in 0.3s ease forwards; }\
    ...
    @media (max-width: 768px) {\
      ...
      .card-quality-badges { top: 0.25em; left: 0.25em; gap: 0.18em; }\
      .card-quality-badge { height: 0.75em; }\
    }\
  </style>';
  $('body').append(style);

  console.log('[QualityBadges] Іконки у верхньому лівому куті з горизонтальним розташуванням і підтримкою UKR');
})();

  console.log('[QualityBadges] Горизонтальне розташування іконок з підтримкою UKR');
})();
